...
<head>
    ...
    <title>See Users - PhoneStore</title>
...
<body>
    ...
    <!--TABLE-->
    <div class="user-container cart-page">
            ...
            $query = "SELECT id, user_id, user_name, password, email, address from users";
            $result = mysqli_query($con,$query);

            if( $result && mysqli_num_rows($result) > 0 ){
                while ( $row = mysqli_fetch_assoc($result) ){
                    echo "<tr><td><div class='cart-info'>". $row['id'] ."</div></td><td><div class='cart-info'>". $row['user_id'] ."</div></td><td><div class='cart-info'>". $row['user_name'] ."</div></td><td><div class='cart-info'>". $row['password'] ."</div></td><td><div class='cart-info'>". $row['email'] ."</div></td><td><div class='cart-info'>". $row['address'] ."</div></td>
